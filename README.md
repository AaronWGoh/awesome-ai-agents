...
- [ModernRelay/omnigraph](https://github.com/ModernRelay/omnigraph) (41 Rust) - Typed property graph database for agent memory and knowledge systems, with Git-style branches and merges, S3-native storage, typed queries, and traversal, BM25, and vector search in one runtime.
